...
- **Accessing our JSON files.** Once you have successfully requested and downloaded the original images, you can download the VQA JSON files provided in our project, which contains four data parts: ColonVQA/ColonEval/ColonPert/ColonReason ([🤗Huggingface](https://huggingface.co/datasets/ai4colonoscopy/Colon-X) or [🔗Google drive](https://drive.google.com/drive/folders/1eY3TW3Q4iod10yQ7lUMVOXFfH24mBrv8?usp=sharing)).
